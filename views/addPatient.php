                ...
                <div class="form"> 
                    ...
                    <div class="form-title">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="lastname" placeholder="Nom" name="lastname"required pattern= "<?=REGEX_NAME?>" value="<?=ucwords($idProfil->lastname) ?? $lastname ?? ''?>">
                            <p class="error"><?= $error['lastname'] ?? '' ?></p>
                        </div>
                        <div class="form-group">
                            <label for="firstname" class="firstname"> Prénom * </label>
                            <input type="text" id="firstname" placeholder="Prénom" name="firstname"required pattern= "<?=REGEX_NAME?>" value="<?=ucwords($idProfil->firstname) ?? $firstname ?? ''?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="birthdate" name="birthdate" value="<?=$idProfil->birthdate ?? $birthdate ?? ''?>" required>
                            <p class="error"><?= $error['birthdate'] ?? '' ?></p>
                        </div> 
                        <div class="form-group">
                            <label for="phone" class="form-label">Numéro de téléphone </label>
                            <input type="tel" class="form-control" name="phone" id="phone" placeholder="N°de téléphone" value="<?=$idProfil->phone ?? $phone ?? '' ?>" required pattern="<?=REGEX_PHONE?>">
                            <p class="error"><?=$error['phone'] ?? ''?></p>
                        </div>
                        <div class="form-group">
                            <label for="mail" class="form-label">Adresse email *</label>
                            <input type="mail" class="form-control" name="mail" id="mail" placeholder="Email" value="<?=$idProfil->mail ?? $mail ?? ''?>" required>
